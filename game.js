...
function addItems() {
  ...
  createItem(500, 50, 'coin');
  createItem(700, 75, 'coin');
  createItem(750, 250, 'coin');
  createItem(300, 35, 'poison');
...
function addPlatforms() {
  ...
  platforms.create(590, 400, 'platform');
  platforms.create(100, 200, 'platform');
  platforms.create(400, 100, 'platform2');
  platforms.create(450, 350, 'platform');
  platforms.create(590, 300, 'platform');
  platforms.create(50, 375, 'platform2');
  platforms.create(20, 100, 'platform2');
